...
dist_pfr_aramco = df_aramco_pfr['Distance_PFRC2_(m)']
dist_pfr_gri = df_gri_pfr['Distance_PFRC2_(m)']
dist_pfr_atr = df_atr_pfr['Distance_PFRC2_(m)']
dist_pfr_nuig = df_nuig_pfr['Distance_PFRC2_(m)']
...
x_H2_pfr_aramco = df_aramco_pfr[' Mass_fraction_H2_PFRC2_()']
x_H2_pfr_gri = df_gri_pfr[' Mass_fraction_H2_PFRC2_()']
x_H2_pfr_atr = df_atr_pfr[' Mass_fraction_H2_PFRC2_()']
x_H2_pfr_nuig = df_nuig_pfr[' Mass_fraction_H2_PFRC2_()']

x_H2O_pfr_aramco = df_aramco_pfr[' Mass_fraction_H2O_PFRC2_()']
x_H2O_pfr_gri = df_gri_pfr[' Mass_fraction_H2O_PFRC2_()']
x_H2O_pfr_atr = df_atr_pfr[' Mass_fraction_H2O_PFRC2_()']
x_H2O_pfr_nuig = df_nuig_pfr[' Mass_fraction_H2O_PFRC2_()']

x_CO_pfr_aramco = df_aramco_pfr[' Mass_fraction_CO_PFRC2_()']
x_CO_pfr_gri = df_gri_pfr[' Mass_fraction_CO_PFRC2_()']
x_CO_pfr_atr = df_atr_pfr[' Mass_fraction_CO_PFRC2_()']
x_CO_pfr_nuig = df_nuig_pfr[' Mass_fraction_CO_PFRC2_()']

x_CO2_pfr_aramco = df_aramco_pfr[' Mass_fraction_CO2_PFRC2_()']
x_CO2_pfr_gri = df_gri_pfr[' Mass_fraction_CO2_PFRC2_()']
x_CO2_pfr_atr = df_atr_pfr[' Mass_fraction_CO2_PFRC2_()']
x_CO2_pfr_nuig = df_nuig_pfr[' Mass_fraction_CO2_PFRC2_()']

x_CH4_pfr_aramco = df_aramco_pfr[' Mass_fraction_CH4_PFRC2_()']
x_CH4_pfr_gri = df_gri_pfr[' Mass_fraction_CH4_PFRC2_()']
x_CH4_pfr_atr = df_atr_pfr[' Mass_fraction_CH4_PFRC2_()']
x_CH4_pfr_nuig = df_nuig_pfr[' Mass_fraction_CH4_PFRC2_()']
...
x_test_pfr_aramco = df_aramco_pfr[' Mass_fraction_N2_PFRC2_()']
x_test_pfr_gri = df_gri_pfr[' Mass_fraction_N2_PFRC2_()']
x_test_pfr_atr = df_atr_pfr[' Mass_fraction_N2_PFRC2_()']
x_test_pfr_nuig = df_nuig_pfr[' Mass_fraction_N2_PFRC2_()']
...
plt.ylabel('Massfraktion')
plt.title('Massfraktionen im PFR - Aramco')
plt.tight_layout()
plt.grid()
#plt.show()
plt.close()

#%# Plots für die verschiedenen Massfraktionen erstellen
...
axs1[0].set_title('H₂')
axs1[0].set_ylabel('Massfraktion')
axs1[0].set_xlabel('Reaktorlänge [m]')
axs1[0].grid(True)
axs1[0].legend()
...
axs1[1].set_xlabel('Reaktorlänge [m]')
axs1[1].grid(True)
axs1[1].legend()
...
axs2[0].set_title('CO')
axs2[0].set_ylabel('Massfraktion')
axs2[0].set_xlabel('Reaktorlänge [m]')
axs2[0].grid(True)
axs2[0].legend()
...
axs2[1].set_title('CO₂')
axs2[1].set_xlabel('Reaktorlänge [m]')
axs2[1].grid(True)
axs2[1].legend()
...
axs3[0].set_xlabel('Reaktorlänge [m]')
axs3[0].grid(True)
axs3[0].legend()
...
axs3[1].set_xlabel('Reaktorlänge [m]')
axs3[1].set_ylabel('Massfraktion ')
axs3[1].grid(True)
axs3[1].legend()
...
for sp in spezien:
    colname = f' Mass_fraction_{sp}_PFRC2_()'
    data_dict[sp] = [
